# ROADMAP — blackroad.network

> Product roadmap for BlackRoad Network
...
- [ ] Deploy index.html to blackroad.network
- [ ] DNS configuration (Gematria or CF)
- [ ] SSL/TLS auto-provisioned
- [ ] RoadCode CI/CD pipeline
- [ ] Mirror to Gitea

**Milestone**: Site live at https://blackroad.network with < 2s load time.

## Phase 2: Product (Week 3-4)

**Goal**: Real product pages with Stripe integration.

- [ ] Product landing pages for: CarPool (NATS), TollBooth (WireGuard), PitStop (Pi-hole), RoadMap (Grafana)
...
**Milestone**: First paying customer through blackroad.network.
...
**Milestone**: blackroad.network is a thriving part of the BlackRoad ecosystem.

---

*BlackRoad OS, Inc. — Pave Tomorrow.*
*Category: infrastructure | Products: CarPool (NATS), TollBooth (WireGuard), PitStop (Pi-hole), RoadMap (Grafana)*
